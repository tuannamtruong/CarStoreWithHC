...
@Readiness
@ApplicationScoped
public class MainDatabaseReadyCheck implements HealthCheck {
    ...
    public HealthCheckResponse call() {
        HealthCheckResponseBuilder responseBuilder = HealthCheckResponse.named("Readiness check example");
        Connection con = null;
        Statement stmt = null;
        ResultSet rs = null;
        try {
